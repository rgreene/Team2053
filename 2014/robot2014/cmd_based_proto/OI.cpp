...
OI::OI() {
	...
	Buttons1[4]->WhenPressed(new FireCommand(1.0));
	Buttons1[5]->WhenPressed(new FireCommand(55.0));
	...
	Buttons2[4]->WhenPressed(new FireCommand(1.0));
	Buttons2[5]->WhenPressed(new FireCommand(55.0));
	...
	SmartDashboard::PutData("Open Latch!",new Open_Latch_Command());
}
